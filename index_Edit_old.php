...
<!--    <script src="js/languages/jquery.validationEngine-en.js" type="text/javascript" charset="utf-8"></script>
	...
	<script src="js/check_text_all.js" type="text/javascript"></script>
   	<script src="js/check_radio_all.js" type="text/javascript"></script>
  <script>
...
function select_year_add(){
	$.post("select_year_add.php", { data: $("#select_year").val()}, 
		function(data){
			$("#show_hospitol").html(data);
		}
	);
				...
				if(document.getElementById("abortion_method_10").checked == true)
					{
						...
						document.getElementById("select_abortion_method_99").disabled=false;
				...
				else
					{
						...
						document.getElementById("select_abortion_method_99").disabled=true;
						...
						document.getElementById("select_abortion_method_99").checked = false;
					}			
	}
...
/*-----------------------------------  check_problem_money ---------------------------------*/
				...
				else if(document.getElementById("check_problem_money_1").checked == true && document.getElementById("problem_money_0").checked == false && document.getElementById("problem_money_1").checked == false && document.getElementById("problem_money_2").checked == false)
							{ 
								alert('กรุณารอกข้อมูลในส่วนสำคัญด้วย');
									$(function() {
									$('#tabs').tabs("option", "active", 1);
									  });
								document.getElementById("problem_money_0").focus();
								return false;			
...
/*-----------------------------------  check_problem_health ---------------------------------*/
				...
				else if(document.getElementById("check_problem_health_1").checked == true && document.getElementById("problem_health_2").checked == false && document.getElementById("problem_health_3").checked == false && document.getElementById("problem_health_4").checked == false && document.getElementById("problem_health_5").checked == false && document.getElementById("problem_health_7").checked == false && document.getElementById("problem_health_8").checked == false && document.getElementById("problem_health_9").checked == false && document.getElementById("problem_health_10").checked == false && document.getElementById("problem_health_11").checked == false && document.getElementById("problem_health_12").checked == false && document.getElementById("problem_health_13").checked == false && document.getElementById("problem_health_14").checked == false)
							{ 
								alert('กรุณารอกข้อมูลในส่วนสำคัญด้วย');
									$(function() {
									$('#tabs').tabs("option", "active", 2);
									  });
								document.getElementById("problem_health_2").focus();
								return false;				 
							}
							
/*-----------------------------------  check_problem_family ---------------------------------*/

				else if(document.getElementById("check_problem_family_1").checked == true && document.getElementById("problem_family_0").checked == false && document.getElementById("problem_family_1").checked == false && document.getElementById("problem_family_2").checked == false && document.getElementById("problem_family_3").checked == false && document.getElementById("problem_family_4").checked == false && document.getElementById("problem_family_5").checked == false && document.getElementById("problem_family_6").checked == false && document.getElementById("problem_family_7").checked == false && document.getElementById("problem_family_8").checked == false && document.getElementById("problem_family_9").checked == false && document.getElementById("problem_family_10").checked == false && document.getElementById("problem_family_11").checked == false)
							{ 
								alert('กรุณารอกข้อมูลในส่วนสำคัญด้วย');
									$(function() {
									$('#tabs').tabs("option", "active", 2);
									  });
								document.getElementById("problem_family_0").focus();
								return false;				 
							}

/*-----------------------------------  check_group_effect ---------------------------------*/

				else if(document.getElementById("check_group_effect_1").checked == true && document.getElementById("group_effect_0").checked == false && document.getElementById("group_effect_1").checked == false && document.getElementById("group_effect_2").checked == false && document.getElementById("group_effect_3").checked == false && document.getElementById("group_effect_4").checked == false && document.getElementById("group_effect_5").checked == false && document.getElementById("group_effect_6").checked == false && document.getElementById("group_effect_7").checked == false && document.getElementById("group_effect_8").checked == false)
							{ 
								alert('กรุณารอกข้อมูลในส่วนสำคัญด้วย');
									$(function() {
									$('#tabs').tabs("option", "active", 2);
									  });
								document.getElementById("group_effect_0").focus();
								return false;				 
							}

/*-----------------------------------  abortion_method_10 ---------------------------------*/

				else if(document.getElementById("abortion_method_10").checked == true && document.getElementById("select_abortion_method_0").checked == false && document.getElementById("select_abortion_method_1").checked == false && document.getElementById("select_abortion_method_2").checked == false && document.getElementById("select_abortion_method_99").checked == false)
							{ 
								alert('กรุณารอกข้อมูลในส่วนสำคัญด้วย');
									$(function() {
									$('#tabs').tabs("option", "active", 2);
									  });
								document.getElementById("select_abortion_method_0").focus();
								return false;				 
							}

/*-----------------------------------  check_group_complications ---------------------------------*/

				else if(document.getElementById("check_group_complications_1").checked == true && document.getElementById("group_complications_1").checked == false && document.getElementById("group_complications_2").checked == false && document.getElementById("group_complications_3").checked == false && document.getElementById("group_complications_4").checked == false && document.getElementById("group_complications_5").checked == false && document.getElementById("group_complications_6").checked == false && document.getElementById("group_complications_7").checked == false && document.getElementById("group_complications_8").checked == false && document.getElementById("group_complications_9").checked == false && document.getElementById("group_complications_10").checked == false && document.getElementById("group_complications_11").checked == false && document.getElementById("group_complications_12").checked == false && document.getElementById("group_complications_14").checked == false && document.getElementById("group_complications_15").checked == false)
							{ 
								alert('กรุณารอกข้อมูลในส่วนสำคัญด้วย');
									$(function() {
									$('#tabs').tabs("option", "active", 3);
									  });
								document.getElementById("group_complications_1").focus();
								return false;				 
							}
...
function check_date(d)
	{
		var date1 = document.getElementById("survey_datefirst").value;
		var date2 = document.getElementById("survey_dateend").value;
...
<!--<input type="text" name="h_check_id" id="h_check_id" >-->
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        <td class="menu_right">ปี พ.ศ.ที่จัดเก็บ :</td>
        <td colspan="3"><label>
          <select name="select_year" id="select_year"  onchange="select_year_add();" >
          <option value="999">-- เลือก --</option>
<?php
	$y_ii = 2014;
	for($y_i=2557;$y_i<=2570;$y_i++)
		{
			
?>
            <option value="<?php echo $y_ii; ?>"><?php echo $y_i; ?></option>
<?php
			$y_ii++;
		}
?>
      ...
      <tr>
        ...
        <td colspan="3"><label>
          <input name="survey_datefirst" type="text" id="survey_datefirst" readonly="readonly" onkeypress="return handleEnter(this, event)"  onchange="check_date('survey_datefirst')" />
      ...
      <tr>
        ...
        <td colspan="3"><label>
          <input name="survey_dateend" type="text" id="survey_dateend" readonly="readonly" onkeypress="return handleEnter(this, event)" onchange="check_date('survey_dateend')"/>
...
<table width="100%" border="0" cellspacing="2" cellpadding="5">
  ...
  <tr>
    ...
    <td valign="top" class="menu_right">&nbsp;</td>
    <td><label>
      <input type="radio" name="nationality" value="99" id="nationality_99" onclick="other_name('text_nationality','')" onkeypress="return handleEnter(this, event)" />
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td><label>
      <input type="radio" name="religion" value="99" id="religion_99" onclick="other_name('text_religion','')" onkeypress="return handleEnter(this, event)" />
      ไม่ทราบ/ไม่ตอบ</label></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2"><label>
      <input type="radio" name="status" value="99" id="status_99"  onkeypress="return handleEnter(this, event)" />
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2"><label>
      <input type="radio" name="job" value="99" id="job_99" onclick="other_name2('text_job1','text_job2','')" onkeypress="return handleEnter(this, event)" />
  ...
  <tr>
    ...
    <td colspan="2">1. จำนวนการตั้งครรภ์ 
      <label>
        <input name="pregnancy_history" type="text" id="pregnancy_history" size="3" maxlength="3"  onchange="check_pregnancy_history()" onblur="check_large1('pregnancy_history');" onkeypress="return handleEnter(this, event)" />
  ...
  <tr>
    ...
    <td>2. จำนวนการคลอด 
      <label>
        <input name="births_history" type="text" id="births_history" size="3" maxlength="3" onblur="check_large('0','15','births_history');" onkeypress="return handleEnter(this, event)" onkeyup="check_int('births_history')" />
      ครั้ง  </label></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>3. จำนวนบุตรมีชีวิต 
      <label>
        <input name="children_history" type="text" id="children_history" size="3" maxlength="3" onblur="check_large('0','15','children_history');" onkeypress="return handleEnter(this, event)" onkeyup="check_int('children_history')" />
      คน  </label></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>4. บุตรคนสุดท้ายอายุ 
      <label>
        <input name="last_daughter_history" type="text" id="last_daughter_history" size="3" maxlength="3"  onkeypress="return handleEnter(this, event)" onkeyup="check_int('last_daughter_history')" />
      ปี</label>
      <input name="last_daughter_history_2" type="text" id="last_daughter_history_2" size="3" maxlength="3" onkeypress="return handleEnter(this, event)" onkeyup="check_int('last_daughter_history_2')" /></label>
      เดือน</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
ครั้ง </label></td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
          <input type="radio" name="select_abortion_method" value="99" id="select_abortion_method_99" disabled="disabled" />
          4. ไม่ทราบ/ไม่ตอบ</label></td>
  </tr>
</table>
<!--    <div align="center"><label><button class="next-product">ต่อไป</button></label></div>-->
...
9. ไตวาย (Renal Failure)</label></td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2"><label>
      <input type="radio" name="group_disposition" value="99" id="group_disposition_99"  onkeypress="return handleEnter(this, event)"  onclick="other_name('text_group_disposition1','')" />
