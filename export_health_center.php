...
<div align="right">
  <h3>ยินดีต้อนรับ : <?php echo $_SESSION["ss_name"]; ?> : <a href="logout.php">Logout</a></h3></div>
...
<table width="100%" border="0" cellspacing="2" cellpadding="10" class="summarize">
  ...
  <tr bgcolor="#B4DCED">
    ...
    <td class="menu_center"><a href="export_health_center_2557.php" target="_blank"><img src="image/Excel.png" width="32" height="32" /></a>
    </td>
  </tr>
  <tr >
    <td class="menu_center">ข้อมูลปี พ.ศ. 2558</td>
    <td class="menu_center"><a href="export_health_center_2558.php" target="_blank"><img src="image/Excel.png" width="32" height="32" /></a>	
	</td>
  </tr>
  <tr bgcolor="#B4DCED">
	<form id="form1" name="form1" method="post" action="export_health_center_2559.php">
    ...
    <td class="menu_center"><a href="export_health_center_2559.php" target="_blank"><img src="image/Excel.png" width="32" height="32" /></a>
	</td>-->
  </tr>
</table>
</div>  
