...
<table width="100%" border="0" cellspacing="2" cellpadding="5">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
        <input type="checkbox" name="group_complications3" value="1" id="group_complications_3"  onkeypress="return handleEnter(this, event)"  disabled="disabled" <?php if($data_hospital[group_complications3]==1){ ?> checked="checked"  <?php } ?>/>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
      <input type="checkbox" name="group_complications4" value="1" id="group_complications_4"  onkeypress="return handleEnter(this, event)" disabled="disabled" <?php if($data_hospital[group_complications4]==1){ ?> checked="checked"  <?php } ?>/>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
      <input type="checkbox" name="group_complications5" value="1" id="group_complications_5"  onkeypress="return handleEnter(this, event)" disabled="disabled" <?php if($data_hospital[group_complications5]==1){ ?> checked="checked"  <?php } ?>/>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
        <input type="checkbox" name="group_complications6" value="1" id="group_complications_6"  onkeypress="return handleEnter(this, event)"  disabled="disabled" <?php if($data_hospital[group_complications6]==1){ ?> checked="checked"  <?php } ?>/>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
        <input type="checkbox" name="group_complications7" value="1" id="group_complications_7"  onkeypress="return handleEnter(this, event)"  disabled="disabled" <?php if($data_hospital[group_complications7]==1){ ?> checked="checked"  <?php } ?>/>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
        <input type="checkbox" name="group_complications8" value="1" id="group_complications_8"  onkeypress="return handleEnter(this, event)"  disabled="disabled" <?php if($data_hospital[group_complications8]==1){ ?> checked="checked"  <?php } ?>/>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
<input type="checkbox" name="group_complications9" value="1" id="group_complications_9"  onkeypress="return handleEnter(this, event)"  disabled="disabled" <?php if($data_hospital[group_complications9]==1){ ?> checked="checked"  <?php } ?>/>
9. ไตวาย (Renal Failure)</label></td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
        <input type="checkbox" name="group_complications10" value="1" id="group_complications_10"  onkeypress="return handleEnter(this, event)"  disabled="disabled" <?php if($data_hospital[group_complications10]==1){ ?> checked="checked"  <?php } ?>/>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
        <input type="checkbox" name="group_complications11" value="1" id="group_complications_11"  onkeypress="return handleEnter(this, event)"  disabled="disabled" <?php if($data_hospital[group_complications11]==1){ ?> checked="checked"  <?php } ?>/>
