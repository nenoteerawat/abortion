...
?>
<div class="table_main" style="width:902px">
<div align="right">
  ...
  <div id="tabs-2">
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        ...
        <?php } else { echo "<div id='show_hospitol'></div>"; } ?> <font color="#FF0000">*</font></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="3"><label>
          ...
          <span class="menu_right">(วันที่แรกรับ) <font color="#FF0000">*</font></span></label></td>
        </tr>
      <tr>
...
ครั้ง </label></td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>      <label>
        <input type="checkbox" disabled="disabled"  name="abortion_method10" value="1" id="abortion_method_9"  onkeypress="return handleEnter(this, event)" />
        10. ไม่ทราบ</label></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
