...
function select_hospitol(){
	$.post("list_hospital_name.php", { data: $("#survey_province").val(), hospital : $("#select_hos").val()}, 
		function(data){
...
<!--<input type="text" name="h_check_id" id="h_check_id" >-->
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        ...
        <?php } else { echo "<div id='show_hospitol'></div>"; } ?> <input name="select_hos" type="hidden" id="select_hos" value="<?php echo $data_hospital['survey_agency']; ?>" /></td>
      </tr>
      <tr>
        ...
        <?php } else { echo  "
		<label>
          <input type='text' name='survey_district' id='show_hospitol_district'  readonly='readonly' value='".$data_hospital['survey_district']."' />
      ...
      <tr>
        ...
        <td colspan="3"><?php if($_SESSION["ss_lavel"] != 1){ ?><label>
          ...
          <?php } else {  echo "       <label>
          <input type='text' name='hospital_id' id='show_hospitol_id' readonly='readonly' value='".$hospital_id."' />
        </label>"		  
		  ; } ?>
          </td>
        </tr>
        ...
        <td colspan="3"><input name="file_id" type="text" id="file_id" size="4" maxlength="4"  onkeyup="check_int('file_id');clearDate();" onblur="convertId();" onkeypress="return handleEnter(this, event);"  value="<?php echo $survey_id; ?>"/>
        </label>
...
<table width="100%" border="0" cellspacing="2" cellpadding="5">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>      <label>
        <input type="radio" name="education" value="8" id="education_7"  onclick="other_name('text_education','')"  onkeypress="return handleEnter(this, event)" <?php if($data_hospital['education']==8){ ?> checked="checked"  <?php } ?> />
  ...
  <tr>
    ...
    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
      <input type="checkbox" name="check_miscarriage" value="1"  <?php if($data_hospital['check_miscarriage']!=1) { ?> disabled="disabled" <?php }else{ ?> checked="checked"  <?php } ?> id="check_miscarriage" onclick="other_name4('check_miscarriage','miscarriage')"/>
    </label>
      1.  แท้งเอง จำนวน 
      <label>
...
ครั้ง </label></td>
  ...
  <tr>
    ...
    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
      <input type="checkbox" name="check_abortion" id="check_abortion" value="1" <?php if($data_hospital['check_abortion']!=1) { ?> disabled="disabled" <?php }else{ ?> checked="checked"  <?php } ?> onclick="other_name6('check_abortion','abortion','first_abortion');"/>
    </label>
      2.  ทำแท้ง จำนวน 
      <label>
    ...
    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
      <input type="checkbox" name="unknown_abortion" id="unknown_abortion" value="1" <?php if($data_hospital['unknown_abortion']!=1) { ?> disabled="disabled" <?php }else{ ?> checked="checked"  <?php } ?> onclick="other_name4('unknown_abortion','unknown_abortion_n')"/>
    </label>
    ...
    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
      <input type="checkbox" name="not_infor" id="not_infor" value="1"  <?php if($data_hospital['not_infor']!=1) { ?> disabled="disabled" <?php }else{ ?> checked="checked" <?php } ?> onclick="other_name6('check_abortion','abortion','first_abortion','unknown_abortion_n')"/>
    </label>
      4. ไม่ยินดีให้ข้อมูล 
      <label></label></td>
    </tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
        <input type="checkbox" name="problem_money4" value="1" id="problem_money_3"  onkeypress="return handleEnter(this, event)" <?php if($data_hospital['check_problem_money']!=1){ ?> disabled="disabled"  <?php } if($data_hospital['problem_money4']==1) {?> checked="checked"  <?php } ?> />
        4. ไม่ยินดีให้ข้อมูล</label></td>
    <td>&nbsp;</td>
  </tr>
...
?>
    <div align="center"><label>
      <input name="h_id_edit" type="hidden" id="h_id_edit" value="<?php echo $_GET['id']; ?>" />
	  <input name="h_year_edit" type="hidden" id="h_year_edit" value="<?php echo $_GET['year']; ?>" />
