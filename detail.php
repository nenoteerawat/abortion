...
<script src="js/tabnavi_2.js"  charset="UTF-8" type="text/javascript"></script>
...
<?php
		...
		$sql_hospital = "select * from abortionsurvey_main where survey_id like '%".$_SESSION["ss_hospital_id"]."%'";
  ...
  <div id="tabs-2">
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        ...
        <td colspan="3"><?php echo $data_hospital[survey_province]; ?></td>
      </tr>
      <tr>
        <td class="menu_right">ชื่อหน่วยงานที่เก็บข้อมูลโรงพยาบาล : </td>
        <td colspan="3"><?php echo $data_hospital[survey_agency]; ?></td>
      </tr>
      <tr>
        <td class="menu_right">อำเภอ : </td>
        <td colspan="3"><?php echo $data_hospital[survey_district]; ?></td>
      </tr>
      <tr>
        <td width="36%" class="menu_right">รหัสโรงพยาบาล : </td>
        <td colspan="3"><?php echo $hospital_id."  "; ?><span class="menu_right"> แบบสอบถามหมายเลข :  <?php echo $survey_id; ?> </span>
          </label></td>
        </tr>
      <tr>
        <td class="menu_right">ชื่อ - สกุล เจ้าหน้าที่เก็บข้อมูล : </td>
        <td width="21%"><?php echo $data_hospital[survey_name]; ?></td>
        <td class="menu_right">ตำแหน่ง : </td>
        <td><?php echo $data_hospital[survey_position]; ?></td>
      </tr>
      <tr>
        <td class="menu_right">วัน/ เดือน/ ปีที่อาสาสมัครมาโรงพยาบาล  : </td>
        <td colspan="3"><label><?php echo $survey_datefirst; ?><span class="menu_right"> (วันที่แรกรับ) </span></label></td>
        </tr>
      <tr>
        <td class="menu_right">วัน/ เดือน/ ปีที่จำหน่ายจากโรงพยาบาล : </td>
        <td colspan="3"><label><?php echo $survey_dateend; ?></label></td>
        </tr>
...
<table width="100%" border="0" cellspacing="2" cellpadding="5">
  ...
  <tr>
    ...
    <td colspan="2">อายุของท่าน <label>        <?php 
		
			if(!empty($data_hospital[age]))
				{
					echo $data_hospital[age];
				}
			else
				{
					echo " - ";
  ...
  <tr>
    ...
    <td colspan="2">ทราบอายุของสามีหรือเพื่อนชาย 
            <label>
              <input type="radio" name="friend_age" value="1" id="friend_age_0" <?php if($data_hospital[friend_age]==1){ ?> checked="checked" readonly="readonly" <?php } ?> />
            ทราบ</label>
      กรุณาระบุ 
      <label>
        <?php 
		
			if(!empty($data_hospital[text_friend_age]))
				{
					echo $data_hospital[text_friend_age];
				}
			else
				{
					echo " - ";
  ...
  <tr>
    <td colspan="2">      <label><font color="#FFFFFF">
      ทราบอายุของสามีหรือเพื่อนชาย </font><input type="radio" name="friend_age" value="2" id="friend_age_1" <?php if($data_hospital[friend_age]==2){ ?> checked="checked" readonly="readonly" <?php } ?> />
      ไม่ทราบ</label></td>
    </tr>
  <tr>
    <td valign="top" class="menu_right">&nbsp;</td>
  ...
  <tr>
    ...
    <td width="53%">
      <label>
        <input type="radio" name="nationality" value="1" id="nationality_0" <?php if($data_hospital[nationality]==1){ ?> checked="checked" readonly="readonly" <?php } ?> />
        ไทย</label>
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td valign="top" class="menu_right">&nbsp;</td>
    <td width="53%">      <label>
        <input type="radio" name="nationality" value="2" id="nationality_1" <?php if($data_hospital[nationality]==2){ ?> checked="checked" readonly="readonly" <?php } ?> />
        พม่า
    </label></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td valign="top" class="menu_right">&nbsp;</td>
    <td width="53%">      <label>
        <input type="radio" name="nationality" value="3" id="nationality_2" <?php if($data_hospital[nationality]==3){ ?> checked="checked" readonly="readonly" <?php } ?> />
        ลาว</label></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td valign="top" class="menu_right">&nbsp;</td>
    <td width="53%">      <label>
        <input type="radio" name="nationality" value="4" id="nationality_3" <?php if($data_hospital[nationality]==4){ ?> checked="checked" readonly="readonly" <?php } ?> />
        กัมพูชา</label></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>&nbsp;</td>
    <td>      <label>
        <input type="radio" name="nationality" value="5" id="nationality_4" <?php if($data_hospital[nationality]==5){ ?> checked="checked" readonly="readonly" <?php } ?> />
        อื่นๆ</label>
      ระบุ 
      <label>
        ...
        <?php 
			...
			if(!empty($data_hospital[text_nationality]))
				{
					echo $data_hospital[text_nationality];
				}
			else
				{
					echo " - ";
  ...
  <tr>
    ...
    <td>
      <label>
        <input type="radio" name="religion" value="1" id="religion_0" <?php if($data_hospital[religion]==1){ ?> checked="checked" readonly="readonly" <?php } ?> />
        พุทธ</label>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>     <label>
        <input type="radio" name="religion" value="2" id="religion_1" <?php if($data_hospital[religion]==2){ ?> checked="checked" readonly="readonly" <?php } ?> />
        คริสต์</label></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>&nbsp;</td>
    <td>      <label>
        <input type="radio" name="religion" value="3" id="religion_2" <?php if($data_hospital[religion]==3){ ?> checked="checked" readonly="readonly" <?php } ?> />
        อิสลาม</label></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>&nbsp;</td>
    <td>      <label>
        <input type="radio" name="religion" value="4" id="religion_3" <?php if($data_hospital[religion]==4){ ?> checked="checked" readonly="readonly" <?php } ?> />
</label>
        อื่น ๆ ระบุ<label>
        
        <?php 
		
			if(!empty($data_hospital[text_religion]))
				{
					echo $data_hospital[text_religion];
				}
			else
				{
					echo " - ";
  ...
  <tr>
    ...
    <td colspan="2">
      <label>
        ...
        1.1 มี ประมาณ</label>
      <label>
        <input name="text_friend" type="text" disabled="disabled"  id="text_friend" maxlength="10"  onkeypress="return handleEnter(this, event)" onkeyup="check_int('text_friend');" />
        บาท/เดือน </label></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>4. บุตรคนสุดท้ายอายุ 
      <label>
        <input name="last_daughter_history" type="text" id="last_daughter_history" size="3" maxlength="3"  onkeypress="return handleEnter(this, event)" />
      ปี</label>
      <label for="last_daughter_history_2"></label>
      <input name="last_daughter_history_2" type="text" id="last_daughter_history_2" size="3" maxlength="3" /> 
      เดือน</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
